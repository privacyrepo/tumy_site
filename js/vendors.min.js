...
!*/
!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define(t):e.anime=t()}(this,function(){var o={update:null,begin:null,loopBegin:null,changeBegin:null,change:null,changeComplete:null,loopComplete:null,complete:null,loop:1,direction:"normal",autoplay:!0,timelineOffset:0},_={duration:1e3,delay:0,endDelay:0,easing:"easeOutElastic(1, .5)",round:0},j=["translateX","translateY","translateZ","rotate","rotateX","rotateY","rotateZ","scale","scaleX","scaleY","scaleZ","skew","skewX","skewY","perspective","matrix","matrix3d"],u={CSS:{},springs:{}};function S(e,t,i){return Math.min(Math.max(e,t),i)}function c(e,t){return-1<e.indexOf(t)}function s(e,t){return e.apply(null,t)}var x={arr:function(e){return Array.isArray(e)},obj:function(e){return c(Object.prototype.toString.call(e),"Object")},pth:function(e){return x.obj(e)&&e.hasOwnProperty("totalLength")},svg:function(e){return e instanceof SVGElement},inp:function(e){return e instanceof HTMLInputElement},dom:function(e){return e.nodeType||x.svg(e)},str:function(e){return"string"==typeof e},fnc:function(e){return"function"==typeof e},und:function(e){return void 0===e},nil:function(e){return x.und(e)||null===e},hex:function(e){return/(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(e)},rgb:function(e){return/^rgb/.test(e)},hsl:function(e){return/^hsl/.test(e)},col:function(e){return x.hex(e)||x.rgb(e)||x.hsl(e)},key:function(e){return!o.hasOwnProperty(e)&&!_.hasOwnProperty(e)&&"targets"!==e&&"keyframes"!==e}};function p(e){return(e=/\(([^)]+)\)/.exec(e))?e[1].split(",").map(function(e){return parseFloat(e)}):[]}function a(r,i){var e=p(r),t=S(x.und(e[0])?1:e[0],.1,100),n=S(x.und(e[1])?100:e[1],.1,100),s=S(x.und(e[2])?10:e[2],.1,100),e=S(x.und(e[3])?0:e[3],.1,100),a=Math.sqrt(n/t),o=s/(2*Math.sqrt(n*t)),l=o<1?a*Math.sqrt(1-o*o):0,c=o<1?(o*a-e)/l:-e+a;function d(e){var t=i?i*e/1e3:e,t=o<1?Math.exp(-t*o*a)*(+Math.cos(l*t)+c*Math.sin(l*t)):(1+c*t)*Math.exp(-t*a);return 0===e||1===e?e:1-t}return i?d:function(){var e=u.springs[r];if(e)return e;for(var t=0,i=0;;)if(1===d(t+=1/6)){if(16<=++i)break}else i=0;return u.springs[r]=t*(1/6)*1e3}}function B(t){return void 0===t&&(t=10),function(e){return Math.ceil(S(e,1e-6,1)*t)*(1/t)}}function F(b,t,_,i){if(0<=b&&b<=1&&0<=_&&_<=1){var w=new Float32Array(11);if(b!==t||_!==i)for(var e=0;e<11;++e)w[e]=T(.1*e,b,_);return function(e){return b===t&&_===i||0===e||1===e?e:T(function(e){for(var t=0,i=1;10!==i&&w[i]<=e;++i)t+=.1;var r=t+(e-w[--i])/(w[i+1]-w[i])*.1,n=E(r,b,_);if(.001<=n){for(var s=e,a=r,o=b,l=_,c=0;c<4;++c){var d=E(a,o,l);if(0===d)return a;a-=(T(a,o,l)-s)/d}return a}if(0===n)return r;for(var u,p,h=e,f=t,m=t+.1,g=b,v=_,y=0;0<(u=T(p=f+(m-f)/2,g,v)-h)?m=p:f=p,1e-7<Math.abs(u)&&++y<10;);return p}(e),t,i)}}}function r(e,t){return 1-3*t+3*e}function T(e,t,i){return((r(t,i)*e+(3*i-6*t))*e+3*t)*e}function E(e,t,i){return 3*r(t,i)*e*e+2*(3*i-6*t)*e+3*t}t={linear:function(){return function(e){return e}}},i={Sine:function(){return function(e){return 1-Math.cos(e*Math.PI/2)}},Expo:function(){return function(e){return e?Math.pow(2,10*e-10):0}},Circ:function(){return function(e){return 1-Math.sqrt(1-e*e)}},Back:function(){return function(e){return e*e*(3*e-2)}},Bounce:function(){return function(e){for(var t,i=4;e<((t=Math.pow(2,--i))-1)/11;);return 1/Math.pow(4,3-i)-7.5625*Math.pow((3*t-2)/22-e,2)}},Elastic:function(e,t){void 0===t&&(t=.5);var i=S(e=void 0===e?1:e,1,10),r=S(t,.1,2);return function(e){return 0===e||1===e?e:-i*Math.pow(2,10*(e-1))*Math.sin((e-1-r/(2*Math.PI)*Math.asin(1/i))*(2*Math.PI)/r)}}},["Quad","Cubic","Quart","Quint"].forEach(function(e,t){i[e]=function(){return function(e){return Math.pow(e,t+2)}}}),Object.keys(i).forEach(function(e){var r=i[e];t["easeIn"+e]=r,t["easeOut"+e]=function(t,i){return function(e){return 1-r(t,i)(1-e)}},t["easeInOut"+e]=function(t,i){return function(e){return e<.5?r(t,i)(2*e)/2:1-r(t,i)(-2*e+2)/2}},t["easeOutIn"+e]=function(t,i){return function(e){return e<.5?(1-r(t,i)(1-2*e))/2:(r(t,i)(2*e-1)+1)/2}}});var t,i,l=t;function C(e,t){if(x.fnc(e))return e;var i=e.split("(")[0],r=l[i],n=p(e);switch(i){case"spring":return a(e,t);case"cubicBezier":return s(F,n);case"steps":return s(B,n);default:return s(r,n)}}function n(e){try{return document.querySelectorAll(e)}catch(e){}}function M(e,t){for(var i,r=e.length,n=2<=arguments.length?t:void 0,s=[],a=0;a<r;a++)a in e&&(i=e[a],t.call(n,i,a,e))&&s.push(i);return s}function d(e){return e.reduce(function(e,t){return e.concat(x.arr(t)?d(t):t)},[])}function h(e){return x.arr(e)?e:(e=x.str(e)&&n(e)||e)instanceof NodeList||e instanceof HTMLCollection?[].slice.call(e):[e]}function f(e,t){return e.some(function(e){return e===t})}function m(e){var t,i={};for(t in e)i[t]=e[t];return i}function w(e,t){var i,r=m(e);for(i in e)r[i]=(t.hasOwnProperty(i)?t:e)[i];return r}function k(e,t){var i,r=m(e);for(i in t)r[i]=(x.und(e[i])?t:e)[i];return r}function I(e){if(e=/[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?(%|px|pt|em|rem|in|cm|mm|ex|ch|pc|vw|vh|vmin|vmax|deg|rad|turn)?$/.exec(e))return e[1]}function g(e,t){return x.fnc(e)?e(t.target,t.id,t.total):e}function v(e,t){return e.getAttribute(t)}function y(e,t,i){var r,n,s;return f([i,"deg","rad","turn"],I(t))?t:(r=u.CSS[t+i],x.und(r)?(n=document.createElement(e.tagName),(e=e.parentNode&&e.parentNode!==document?e.parentNode:document.body).appendChild(n),n.style.position="absolute",n.style.width=100+i,s=100/n.offsetWidth,e.removeChild(n),e=s*parseFloat(t),u.CSS[t+i]=e):r)}function N(e,t,i){var r;if(t in e.style)return r=t.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase(),t=e.style[t]||getComputedStyle(e).getPropertyValue(r)||"0",i?y(e,t,i):t}function b(e,t){return x.dom(e)&&!x.inp(e)&&(!x.nil(v(e,t))||x.svg(e)&&e[t])?"attribute":x.dom(e)&&f(j,t)?"transform":x.dom(e)&&"transform"!==t&&N(e,t)?"css":null!=e[t]?"object":void 0}function H(e){if(x.dom(e)){for(var t,i=e.style.transform||"",r=/(\w+)\(([^)]*)\)/g,n=new Map;t=r.exec(i);)n.set(t[1],t[2]);return n}}function A(e,t,i,r){switch(b(e,t)){case"transform":return n=e,a=r,o=i,l=c(s=t,"scale")?1:0+(c(l=s,"translate")||"perspective"===l?"px":c(l,"rotate")||c(l,"skew")?"deg":void 0),l=H(n).get(s)||l,a&&(a.transforms.list.set(s,l),a.transforms.last=s),o?y(n,l,o):l;case"css":return N(e,t,i);case"attribute":return v(e,t);default:return e[t]||0}var n,s,a,o,l}function O(e,t){var i=/^(\*=|\+=|-=)/.exec(e);if(!i)return e;var r=I(e)||0,n=parseFloat(t),s=parseFloat(e.replace(i[0],""));switch(i[0][0]){case"+":return n+s+r;case"-":return n-s+r;case"*":return n*s+r}}function W(e,t){var i,r,n,s,a,o,l;return x.col(e)?(i=e,x.rgb(i)?(o=/rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(r=i))?"rgba("+o[1]+",1)":r:x.hex(i)?(o=(o=i).replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(e,t,i,r){return t+t+i+i+r+r}),o=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(o),"rgba("+parseInt(o[1],16)+","+parseInt(o[2],16)+","+parseInt(o[3],16)+",1)"):x.hsl(i)?(r=/hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(r=i)||/hsla\((\d+),\s*([\d.]+)%,\s*([\d.]+)%,\s*([\d.]+)\)/g.exec(r),i=parseInt(r[1],10)/360,o=parseInt(r[2],10)/100,l=parseInt(r[3],10)/100,r=r[4]||1,0==o?n=s=a=l:(n=c(o=2*l-(l=l<.5?l*(1+o):l+o-l*o),l,i+1/3),s=c(o,l,i),a=c(o,l,i-1/3)),"rgba("+255*n+","+255*s+","+255*a+","+r+")"):void 0):/\s/g.test(e)?e:(o=(o=I(e))?e.substr(0,e.length-o.length):e,t?o+t:o);function c(e,t,i){return i<0&&(i+=1),1<i&&--i,i<1/6?e+6*(t-e)*i:i<.5?t:i<2/3?e+(t-e)*(2/3-i)*6:e}}function L(e,t){return Math.sqrt(Math.pow(t.x-e.x,2)+Math.pow(t.y-e.y,2))}function q(e){for(var t,i=e.points,r=0,n=0;n<i.numberOfItems;n++){var s=i.getItem(n);0<n&&(r+=L(t,s)),t=s}return r}function Y(e){if(e.getTotalLength)return e.getTotalLength();switch(e.tagName.toLowerCase()){case"circle":return 2*Math.PI*v(e,"r");case"rect":return 2*v(t=e,"width")+2*v(t,"height");case"line":return L({x:v(t=e,"x1"),y:v(t,"y1")},{x:v(t,"x2"),y:v(t,"y2")});case"polyline":return q(e);case"polygon":return t=e.points,q(e)+L(t.getItem(t.numberOfItems-1),t.getItem(0))}var t}function $(t,e){var i=(t=(e=e||{}).el||function(){for(var e=t.parentNode;x.svg(e)&&x.svg(e.parentNode);)e=e.parentNode;return e}()).getBoundingClientRect(),r=v(t,"viewBox"),n=i.width,i=i.height,e=e.viewBox||(r?r.split(" "):[0,0,n,i]);return{el:t,viewBox:e,x:+e[0],y:+e[1],w:n,h:i,vW:e[2],vH:e[3]}}function X(e,t){var i=/[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,r=W(x.pth(e)?e.totalLength:e,t)+"";return{original:r,numbers:r.match(i)?r.match(i).map(Number):[0],strings:x.str(e)||t?r.split(i):[]}}function P(e){return M(e?d(x.arr(e)?e.map(h):h(e)):[],function(e,t,i){return i.indexOf(e)===t})}function G(e){var i=P(e);return i.map(function(e,t){return{target:e,id:t,total:i.length,transforms:{list:H(e)}}})}function V(e,t){var i,r=[],n=t.keyframes;for(i in t=n?k(function(e){for(var t=M(d(e.map(function(e){return Object.keys(e)})),function(e){return x.key(e)}).reduce(function(e,t){return e.indexOf(t)<0&&e.push(t),e},[]),i={},n=0;n<t.length;n++)!function(){var r=t[n];i[r]=e.map(function(e){var t,i={};for(t in e)x.key(t)?t==r&&(i.value=e[t]):i[t]=e[t];return i})}();return i}(n),t):t)x.key(i)&&r.push({name:i,tweens:function(e,i){var t,r=m(i),n=(/^spring/.test(r.easing)&&(r.duration=a(r.easing)),x.arr(e)&&(2!==(t=e.length)||x.obj(e[0])?x.fnc(i.duration)||(r.duration=i.duration/t):e={value:e}),x.arr(e)?e:[e]);return n.map(function(e,t){return e=x.obj(e)&&!x.pth(e)?e:{value:e},x.und(e.delay)&&(e.delay=t?0:i.delay),x.und(e.endDelay)&&(e.endDelay=t===n.length-1?i.endDelay:0),e}).map(function(e){return k(e,r)})}(t[i],e)});return r}var U={css:function(e,t,i){return e.style[t]=i},attribute:function(e,t,i){return e.setAttribute(t,i)},object:function(e,t,i){return e[t]=i},transform:function(e,t,i,r,n){var s;r.list.set(t,i),t!==r.last&&!n||(s="",r.list.forEach(function(e,t){s+=t+"("+e+") "}),e.style.transform=s)}};function Q(e,a){G(e).forEach(function(e){for(var t in a){var i=g(a[t],e),r=e.target,n=A(r,t,s=I(i),e),i=O(W(i,s||I(n)),n),s=b(r,t);U[s](r,t,i,e.transforms,!0)}})}function K(e,t){return M(d(e.map(function(s){return t.map(function(e){var t,i,o,l,c,r=s,n=b(r.target,e.name);if(n)return l=r,i=(t=(o=e).tweens.map(function(e){var t=(e=function(e,t){var i,r={};for(i in e){var n=g(e[i],t);x.arr(n)&&1===(n=n.map(function(e){return g(e,t)})).length&&(n=n[0]),r[i]=n}return r.duration=parseFloat(r.duration),r.delay=parseFloat(r.delay),r}(e,l)).value,i=x.arr(t)?t[1]:t,r=I(i),n=A(l.target,o.name,r,l),s=c?c.to.original:n,a=x.arr(t)?t[0]:s,n=I(a)||I(n),r=r||n;return x.und(i)&&(i=s),e.from=X(a,r),e.to=X(O(i,a),r),e.start=c?c.end:0,e.end=e.start+e.delay+e.duration+e.endDelay,e.easing=C(e.easing,e.duration),e.isPath=x.pth(t),e.isPathTargetInsideSVG=e.isPath&&x.svg(l.target),e.isColor=x.col(e.from.original),e.isColor&&(e.round=1),c=e}))[t.length-1],{type:n,property:e.name,animatable:r,tweens:t,duration:i.end,delay:t[0].delay,endDelay:i.endDelay}})})),function(e){return!x.und(e)})}function Z(e,t){function i(e){return e.timelineOffset||0}var r=e.length,n={};return n.duration=r?Math.max.apply(Math,e.map(function(e){return i(e)+e.duration})):t.duration,n.delay=r?Math.min.apply(Math,e.map(function(e){return i(e)+e.delay})):t.delay,n.endDelay=r?n.duration-Math.max.apply(Math,e.map(function(e){return i(e)+e.duration-e.endDelay})):t.endDelay,n}var z,J=0,D=[],ee=("undefined"!=typeof document&&document.addEventListener("visibilitychange",function(){R.suspendWhenDocumentHidden&&(e()?z=cancelAnimationFrame(z):(D.forEach(function(e){return e._onDocumentVisibility()}),ee()))}),function(){!(z||e()&&R.suspendWhenDocumentHidden)&&0<D.length&&(z=requestAnimationFrame(te))});function te(e){for(var t=D.length,i=0;i<t;){var r=D[i];r.paused?(D.splice(i,1),t--):(r.tick(e),i++)}z=0<i?requestAnimationFrame(te):void 0}function e(){return document&&document.hidden}function R(e){var l,c=0,d=0,u=0,p=0,h=null;function f(e){var t=window.Promise&&new Promise(function(e){return h=e});e.finished=t}t=w(o,e=void 0===e?{}:e),i=V(r=w(_,e),e),r=Z(i=K(e=G(e.targets),i),r),n=J,J++;var t,i,r,n,T=k(t,{id:n,children:[],animatables:e,animations:i,duration:r.duration,delay:r.delay,endDelay:r.endDelay});function m(){var e=T.direction;"alternate"!==e&&(T.direction="normal"!==e?"normal":"reverse"),T.reversed=!T.reversed,l.forEach(function(e){return e.reversed=T.reversed})}function g(e){return T.reversed?T.duration-e:e}function s(){c=0,d=g(T.currentTime)*(1/R.speed)}function v(e,t){t&&t.seek(e-t.timelineOffset)}function y(t){for(var e=0,i=T.animations,r=i.length;e<r;){for(var n=i[e],s=n.animatable,a=n.tweens,o=a[l=a.length-1],l=(l&&(o=M(a,function(e){return t<e.end})[0]||o),S(t-o.start-o.delay,0,o.duration)/o.duration),c=isNaN(l)?1:o.easing(l),d=o.to.strings,u=o.round,p=[],h=o.to.numbers.length,f=void 0,m=0;m<h;m++){var g=void 0,v=o.to.numbers[m],y=o.from.numbers[m]||0,g=o.isPath?function(t,i,e){function r(e){return t.el.getPointAtLength(1<=i+(e=void 0===e?0:e)?i+e:0)}var n=$(t.el,t.svg),s=r(),a=r(-1),o=r(1),l=e?1:n.w/n.vW,c=e?1:n.h/n.vH;switch(t.property){case"x":return(s.x-n.x)*l;case"y":return(s.y-n.y)*c;case"angle":return 180*Math.atan2(o.y-a.y,o.x-a.x)/Math.PI}}(o.value,c*v,o.isPathTargetInsideSVG):y+c*(v-y);!u||o.isColor&&2<m||(g=Math.round(g*u)/u),p.push(g)}var b=d.length;if(b)for(var f=d[0],_=0;_<b;_++){d[_];var w=d[_+1],x=p[_];isNaN(x)||(f+=w?x+w:x+" ")}else f=p[0];U[n.type](s.target,n.property,f,s.transforms),n.currentValue=f,e++}}function b(e){T[e]&&!T.passThrough&&T[e](T)}function a(e){var t=T.duration,i=T.delay,r=t-T.endDelay,n=g(e);if(T.progress=S(n/t*100,0,100),T.reversePlayback=n<T.currentTime,l){var s=n;if(T.reversePlayback)for(var a=p;a--;)v(s,l[a]);else for(var o=0;o<p;o++)v(s,l[o])}!T.began&&0<T.currentTime&&(T.began=!0,b("begin")),!T.loopBegan&&0<T.currentTime&&(T.loopBegan=!0,b("loopBegin")),n<=i&&0!==T.currentTime&&y(0),(r<=n&&T.currentTime!==t||!t)&&y(t),i<n&&n<r?(T.changeBegan||(T.changeBegan=!0,T.changeCompleted=!1,b("changeBegin")),b("change"),y(n)):T.changeBegan&&(T.changeCompleted=!0,T.changeBegan=!1,b("changeComplete")),T.currentTime=S(n,0,t),T.began&&b("update"),t<=e&&(d=0,T.remaining&&!0!==T.remaining&&T.remaining--,T.remaining?(c=u,b("loopComplete"),T.loopBegan=!1,"alternate"===T.direction&&m()):(T.paused=!0,T.completed||(T.completed=!0,b("loopComplete"),b("complete"),!T.passThrough&&"Promise"in window&&(h(),f(T)))))}return f(T),T.reset=function(){var e=T.direction;T.passThrough=!1,T.currentTime=0,T.progress=0,T.paused=!0,T.began=!1,T.loopBegan=!1,T.changeBegan=!1,T.completed=!1,T.changeCompleted=!1,T.reversePlayback=!1,T.reversed="reverse"===e,T.remaining=T.loop,l=T.children;for(var t=p=l.length;t--;)T.children[t].reset();(T.reversed&&!0!==T.loop||"alternate"===e&&1===T.loop)&&T.remaining++,y(T.reversed?T.duration:0)},T._onDocumentVisibility=s,T.set=function(e,t){return Q(e,t),T},T.tick=function(e){a(((u=e)+(d-(c=c||u)))*R.speed)},T.seek=function(e){a(g(e))},T.pause=function(){T.paused=!0,s()},T.play=function(){T.paused&&(T.completed&&T.reset(),T.paused=!1,D.push(T),s(),ee())},T.reverse=function(){m(),T.completed=!T.reversed,s()},T.restart=function(){T.reset(),T.play()},T.remove=function(e){re(P(e),T)},T.reset(),T.autoplay&&T.play(),T}function ie(e,t){for(var i=t.length;i--;)f(e,t[i].animatable.target)&&t.splice(i,1)}function re(e,t){var i=t.animations,r=t.children;ie(e,i);for(var n=r.length;n--;){var s=r[n],a=s.animations;ie(e,a),a.length||s.children.length||r.splice(n,1)}i.length||r.length||t.pause()}return R.version="3.2.2",R.speed=1,R.suspendWhenDocumentHidden=!0,R.running=D,R.remove=function(e){for(var t=P(e),i=D.length;i--;)re(t,D[i])},R.get=A,R.set=Q,R.convertPx=y,R.path=function(e,t){var i=x.str(e)?n(e)[0]:e,r=t||100;return function(e){return{property:e,el:i,svg:$(i),totalLength:Y(i)*(r/100)}}},R.setDashoffset=function(e){var t=Y(e);return e.setAttribute("stroke-dasharray",t),t},R.stagger=function(e,t){var o=(t=void 0===t?{}:t).direction||"normal",l=t.easing?C(t.easing):null,c=t.grid,d=t.axis,u=t.from||0,p="first"===u,h="center"===u,f="last"===u,m=x.arr(e),g=m?parseFloat(e[0]):parseFloat(e),v=m?parseFloat(e[1]):0,y=I(m?e[1]:e)||0,b=t.start||0+(m?g:0),_=[],w=0;return function(e,t,i){if(p&&(u=0),h&&(u=(i-1)/2),f&&(u=i-1),!_.length){for(var r,n,s,a=0;a<i;a++)c?(r=h?(c[0]-1)/2:u%c[0],n=h?(c[1]-1)/2:Math.floor(u/c[0]),r-=a%c[0],n-=Math.floor(a/c[0]),s=Math.sqrt(r*r+n*n),"x"===d&&(s=-r),_.push(s="y"===d?-n:s)):_.push(Math.abs(u-a)),w=Math.max.apply(Math,_);l&&(_=_.map(function(e){return l(e/w)*w})),"reverse"===o&&(_=_.map(function(e){return d?e<0?-1*e:-e:Math.abs(w-e)}))}return b+(m?(v-g)/w:g)*(Math.round(100*_[t])/100)+y}},R.timeline=function(a){var o=R(a=void 0===a?{}:a);return o.duration=0,o.add=function(e,t){var i=D.indexOf(o),r=o.children;function n(e){e.passThrough=!0}-1<i&&D.splice(i,1);for(var s=0;s<r.length;s++)n(r[s]);return(i=k(e,w(_,a))).targets=i.targets||a.targets,e=o.duration,i.autoplay=!1,i.direction=o.direction,i.timelineOffset=x.und(t)?e:O(t,e),n(o),o.seek(i.timelineOffset),n(t=R(i)),r.push(t),e=Z(r,a),o.delay=e.delay,o.endDelay=e.endDelay,o.duration=e.duration,o.seek(0),o.reset(),o.autoplay&&o.play(),o},o},R.easing=C,R.penner=l,R.random=function(e,t){return Math.floor(Math.random()*(t-e+1))+e},R});
/*!
    Atropos
    Version: 2.0.2
